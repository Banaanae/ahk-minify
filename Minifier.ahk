...
;Ctrl := MinifyGui.AddCheckBox("x230 y50 w100 h30", "Less Gui Lines") <- Not sure if possible
;Ctrl := MinifyGui.AddCheckBox("x340 y50 w100 h30", "CheckBox")
